...
Add a comment with `%% Comment %%`like this: %%This is a markdown comment%%.  Most HTML tags are rendered such as <u>underline</u> or <s>strike</s>, and even comments `<!-- Comment --> `: <!-- This is an HTML Comment --> Use `Alt` to create multiple carets and edit text quickly.
